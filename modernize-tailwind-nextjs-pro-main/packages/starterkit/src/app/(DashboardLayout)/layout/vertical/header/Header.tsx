...
//               {/* Chat */}
//               <Link href="/" className="text-sm text-link dark:text-darklink dark:hover:text-primary px-15 h-10 hover:text-primary flex items-center justify-center" >Chat</Link>

//               {/* Calendar */}
//               <Link href="/" className="text-sm text-link dark:text-darklink dark:hover:text-primary px-15 h-10 hover:text-primary flex items-center justify-center" >Calendar</Link>

//               {/* Email */}
//               <Link href="/" className="text-sm text-link dark:text-darklink dark:hover:text-primary px-15 h-10 hover:text-primary flex items-center justify-center" >Email</Link>
//             </div>
//           </Navbar.Collapse>
